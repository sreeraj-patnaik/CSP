    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          ...
          '100%': { boxShadow: '0 0 30px rgba(6, 182, 212, 0.7), 0 0 60px rgba(6, 182, 212, 0.3)' },
        },
      },
      backdropBlur: {
        xs: '2px',
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'linear-gradient(135deg, #0A0F1E 0%, #0F172A 25%, #1a0533 50%, #0F172A 75%, #0A1628 100%)',
      },
      boxShadow: {
